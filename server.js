...
app.use("/api/taches", require("./routes/taskRoutes"));   // json 


app.use("/login.faces", require("./routes/controller/user/authroutes"));
app.use("/",require("./routes/controller/user/authroutes"));
app.use("/tasks", require("./routes/controller/task/taskRoutes"));  // view user



app.use("/admin.faces",require("./routes/controller/admin/user/authroutes"));
app.use("/admin.faces/tasks", require("./routes/controller/admin/task/taskRoutes"));  // view admin 

app.use("/app/api", require("./routes/controller/api/routes"));   //api
